      ...
      <div className="overflow-hidden scroll-smooth">
        ...
        >
          {filteredProducts.map((product, index) => (
            ...
            >
              <div className="absolute inset-0 md:bg-gradient-to-t from-gray-600 to-transparent opacity-50 hover:opacity-0 transition-opacity duration-300"></div>
              ...
              <button
                className="absolute bottom-2 right-2 hover:bg-gradient-to-t bg-gradient-to-b from-orange-500 to-red-500 text-white text-[10px] font-medium p-2 rounded-lg hover:bg-white hover:text-orange transition-all duration-500 border-2 border-white font-sans"
