...
function Slide2() {
  return (
<div className="sm:bg-gradient-to-bl h-screen grid grid-cols-1 md:grid-cols-2 items-center font-sans px-2 md:px-4 max-h-[450px]" style={{ backgroundImage: "url('/images/img4.avif')" }}>
